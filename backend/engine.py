...
# V6.5.2: confidence threshold is unified across every risk mode.
# Risk modes still change stake / drawdown behaviour, not the signal threshold.
NORMAL_MIN_CONFIDENCE = 0.30
AI_MIN_CONFIDENCE = 0.40

PROFILES = {
    "Conservative": RiskProfile("Conservative", 0.005, 0.02, 2, NORMAL_MIN_CONFIDENCE),
    "Balanced": RiskProfile("Balanced", 0.010, 0.04, 3, NORMAL_MIN_CONFIDENCE),
    "Aggressive": RiskProfile("Aggressive", 0.020, 0.08, 4, NORMAL_MIN_CONFIDENCE),
}
